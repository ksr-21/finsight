...
const ChatPage: React.FC<ChatPageProps> = ({ user, transactions, currency, balance }) => {
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-[#efe7de] dark:bg-gray-950 md:relative md:inset-auto md:h-[calc(100vh-5rem)] md:flex-1 overflow-hidden">
      {/* Header */}
      <div className="flex-shrink-0 bg-indigo-600 px-4 py-3 text-white flex items-center gap-3 shadow-md z-20">
